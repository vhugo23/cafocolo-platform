...
export default async function AdminLeadDetailPage({
   ...
   * Lead detail is an admin-only workflow.
   * This page lets the admin review the lead, update status, and create a project.
   */
      ...
      <section className="mx-auto max-w-4xl">
        <div className="mb-8">
          ...
          <p className="mt-2 text-neutral-400">
            Review this customer request and decide the next action.
          </p>
        </div>
